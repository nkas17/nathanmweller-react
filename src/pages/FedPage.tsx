          ...
          <article className="article flex-wrapper">
            <div className="flex-item article__content article__flex-item">
              ...
              >
                <div>
                  <blockquote className="article__blockquote">
                    All parts of MDN (docs and the site itself) are created by
                    an open community of developers. Please join us! ~ MDN
                    homepage
                  </blockquote>
                </div>
              </a>
              ...
              >
                <div>
                  <blockquote className="article__blockquote">
                    ...
                    discusses the practice of front-end engineering ~ Cody
                    Lindley
                  </blockquote>
                </div>
              </a>
              <p className="article__paragraph">
                Why is today&apos;s front-end development so complex, it used to
                be so easy, just some html, a little jQuery and some css...
                <a
                  className="link"
              ...
              >
                <div>
                  <blockquote className="article__blockquote">
                    As images continue to be the largest part of webpage
                    content, it’s critically important for web developers to
                    take
                    <em className="emphasis"> aggressive </em>
                    control of their image sizes and quality in order to deliver
                    a fastest loading, responsive site for their users. ~ Colt
                    McAnlis
                  </blockquote>
                </div>
              </a>
