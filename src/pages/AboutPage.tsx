        ...
        <div className="flex-item main__flex-item">
          ...
          <article className="article flex-wrapper">
            <div className="flex-item article__content">
              ...
              <p className="article__paragraph">
                JavaScript, ES2015, Node.js, npm, React.js, Redux.js, Jest,
                Enzyme, Lodash, jQuery, Backbone.js, Underscore.js, HTML, CSS,
                Sass, Bootstrap, responsive design, Google Analytics, Git, PRPC
              </p>
              <header className="main__header article__header">
                <h3 className="header header_size_medium">education</h3>
              </header>
              <p className="article__paragraph">
                BS in Computer Science with honors from Michigan State
                University
              </p>
              <p className="article__paragraph">
                <a
                  className="link"
                  href="https://www.codeschool.com/users/2817163"
                >
                  Code School Badges
                </a>
              </p>
              ...
              <p className="article__paragraph">
                <a
                  className="link"
                  href="https://www.recipes.nathanmweller.com"
                >
                  recipes
                </a>
              </p>
