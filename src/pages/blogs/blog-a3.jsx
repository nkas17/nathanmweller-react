...
export default () => (
	<div>
		<BlogParagraph>
			...
			<a className="link" href="https://validator.w3.org/">W3C Markup Validation Service</a>{` is the best place to go. There are three ways
			...
			do this? `}<em className="emphasis">Semantic html</em>{`. Here are a couple quotes from `}
			<a className="link" href="http://vanseodesign.com/web-design/semantic-html/">vanseodesign.com</a>
		</BlogParagraph>
		<blockquote className="article__blockquote" cite="http://vanseodesign.com/web-design/semantic-html/">
			{`When people say they want to make something more semantic, 
			they simply want to make that thing more meaningful.`}
		</blockquote>
		<BlogParagraph>
			{`What does semantics mean anyway?`}
		</BlogParagraph>
		<blockquote className="article__blockquote">
			<dl className="definition-list">
				<dt>
					<dfn className="definition-list__term">
						semantics (adj.)
					</dfn>
				</dt>
		...
		<BlogParagraph>
			{`Second, I did some `}
			<a className="link" href="https://app.pluralsight.com/library/courses/responsive-typography/table-of-contents">Pluralsight</a>
