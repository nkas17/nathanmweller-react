  ...
  return (
    <div>
      ...
      <BlogParagraph>
        ...
        and what has ultimately become learning &quote;All Things
        Front-End&quote;. Well it wont be quite All the things, there are just
        too many… but I will cover the pieces required to ensure you will have a
        sound and solid single page application built with
        <a className="link" href="https://facebook.github.io/react/">
          React
        </a>
      ...
      <BlogParagraph>
        ...
        <abbr title="JavaScript">JS</abbr>
        in their
        <abbr title="Java Server Pages">JSP</abbr>s to make the Front-end do
        what they want. Keep in mind though, if you are building websites for
        clients depending on their needs you very well could get away with just
        <abbr title="Hyper Text Markup Language">HTML</abbr>
        and
      ...
      <BlogParagraph>
        Now that I&apos;ve completed my tangent regarding the complexities our
        new Front-End single page apps require let&apos;s get started!
      </BlogParagraph>
      <BlogParagraph>
