...
function A3() {
  return (
    <div>
      <BlogParagraph>
        There have been a few more things I have done to wrap up phase one.
        First, Validating my html.
        ...
        {` is the best place to go. There are three ways
			...
			do this? `}
        <em className="emphasis">Semantic html</em>. Here are a couple quotes
        from
        <a
          className="link"
